...
let as_cmd () = clang [ as_mode; !opt_level; common_flags; !platform_flags; "-target x86_64-linux-gnu" ]

let link_cmd () = clang [ common_flags; !opt_level; !platform_flags; link_flags; "-target x86_64-linux-gnu" ]
